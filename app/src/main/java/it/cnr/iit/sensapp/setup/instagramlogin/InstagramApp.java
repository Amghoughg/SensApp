...
public class InstagramApp {
    ...
    private InstagramWebViewController webViewController;
    ...
    public InstagramApp(Context context, WebView webView, String clientId, String clientSecret,
                        String callbackUrl) {
        ...
        //mDialog = new InstagramDialog(context, webView, mAuthUrl, listener);
        webViewController = new InstagramWebViewController(context, webView, mAuthUrl, listener);
    ...
    public void authorize(AVLoadingIndicatorView loader) {
        //Intent webAuthIntent = new Intent(Intent.ACTION_VIEW);
        //webAuthIntent.setData(Uri.parse(AUTH_URL));
        //mCtx.startActivity(webAuthIntent);

        //mDialog.show();
        webViewController.show(loader);
    }
